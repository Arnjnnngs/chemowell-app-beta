...
//     snapshot should ask about the set a reset can clear LESS THE MARKER ITSELF, and now does.
//     It said "exactly the set a reset can clear" until an audit measured that: the marker IS
//     cleared by a reset and is deliberately NOT counted here (next bullet), so a sentence
//     about a set was off by one key.
